...
# 🚀 Конфигурация Railway с PostgreSQL
# Использование: ./configure-railway-postgres.sh

set -e

echo "🚀 Конфигурация Railway с PostgreSQL..."
...
git add .
git commit -m "Configure Railway for PostgreSQL and Django deployment" || true
git push || true

log_success "Изменения закоммичены!"

# Деплой с Django и PostgreSQL
log_info "Запуск деплоя с Django и PostgreSQL..."
